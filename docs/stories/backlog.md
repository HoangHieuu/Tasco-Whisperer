...
| E03 Ranking And Evaluation | US-008 to US-010 | Transparent ranking, personalization, and public evaluation harness. | in_progress |
...
| US-009 | Hackathon-safe personalization | Phase 3 | normal | Profile boost tests with deterministic fallback. |
...
| US-015 | Agentic evaluation and tuning loop | Phase 5 | normal | Before/after evaluation comparison. |
